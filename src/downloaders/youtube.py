...
class YouTubeDownloader(BaseDownloader):
    ...
    async def get_formats(self, url: str) -> List[Dict]:
        """Fetch formats with signature bypass logic"""
        try:
            ...
            extract_opts = {
                ...
                'quiet': True,
                'no_warnings': True,
                'noplaylist': True, # Ensure we don't accidentally pull a whole list
            }
            ...
            raise DownloadError("No playable formats found. Please try again later.")
    ...
    async def download(self, url: str, format_id: Optional[str] = None) -> Tuple[str, Path]:
        """Download phase with fallback to 'best' to prevent crashes on missing nsig formats"""
        try:
            ...
            # Updated format selection: Try requested, fallback to best overall
            ydl_opts = {
